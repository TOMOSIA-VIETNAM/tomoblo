...
1. Cấu trúc của nó gồm:
    ...
    -   **SceneDelegate**:
        ...
        -   **SceneDelegate** những điều chúng ta cần biết là:
            ...
            -   Danh sách thuộc tính **info.plist** nhận bản khai **Scene** application(Application Scene Manifest), liệt kê các **Scene** là một phần của ứng dụng này, bao gồm tên lớp, đại biểu và bảng phân cảnh của chúng.
    ...
    b.   Bộ phận khác của **SwiftUI**:
        ...
        - Trong giao diện **ContenView** ta thấy 2 thành phần gồm **ContenView** và **ContentView_Previews**:
            ...
            - Bên trong **ContenView** có biến **body: some View** đây chính là **Scene** chính của mỗi **View**, các thành phần bên trong của chúng đều phải tuân theo một giao thức chung **View**, cũng chính là phần khiến ta khó làm quen nhất đối với **SwiftUI**.
